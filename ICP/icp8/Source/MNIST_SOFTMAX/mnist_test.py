...
# restore the saved model from the training data
new_saver = tf.train.import_meta_graph('data/mnist_model_1/00000001/export.meta')
new_saver.restore(sess, 'data/mnist_model_1/00000001/export')
