...
public class ObjectFeatureExtraction {
    public static void main(String args[]) throws IOException {
        ...
        String[] IMAGE_CATEGORIES = {"Pizza", "Fries", "Hamburger"};
        String[] inputImage = {"pizza.jpg", "fries.jpg", "hamburger.jpg"};

        for (int input_class = 0; input_class < 3; input_class++){
            MBFImage mbfImage = ImageUtilities.readMBF(new File(inputFolder + inputImage[input_class]));
