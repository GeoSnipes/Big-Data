...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("apple_pie","baby_back_ribs","baklava","beef_carpaccio")
  ...
  def generateRandomForestModel(sc: SparkContext): Unit = {
    ...
    val randomForestModel = RandomForest.trainClassifier(parsedData, numClasses, categoricalFeaturesInfo, bestnumTrees,
      bestFeatureSubSet, bestimpurity, bestmaxdepth, maxBins)
    // Save and load model
