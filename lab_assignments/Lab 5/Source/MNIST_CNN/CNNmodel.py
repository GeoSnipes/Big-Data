...
mnist = input_data.read_data_sets('MNIST_data', one_hot=True, validation_size=300)
...
for i in range(1000):
    ...
    summary, _ = sess.run([merged, train_step_adam], feed_dict={x: batch_adam[0], y_: batch_adam[1], keep_prob: 0.5})
